<template>
	<div class="card">
        ...
        <div class="flex gap-2 items-center cursor-pointer">
          <Avatar image="/user.png" shape="circle" class="custom-shadow" @click="toggle" />
        </div>
			</template>
		</MegaMenu>
	</div>
	...
	<Popover ref="op">
		<div class="flex flex-col gap-4 w-[15rem]">
			<div class="border-b-2">
				<span class="font-semibold block mb-2"><i class="pi pi-fw pi-bell"></i> Notificaciones</span>
			</div>
      ...
      <div class="flex justify-end m-0 p-0">
        <Button label="Cerrar sesión" size="small" severity="danger" text raised @click="closeSession" />
      </div>
		</div>
	</Popover>
</template>
